...
public class AnchorFieldExpression<A> implements Expression<A, A> {
	private final DBugAnchorType<A> theType;

	public AnchorFieldExpression(DBugAnchorType<A> type) {
		theType = type;
	}
	...
	public boolean equals(Object obj) {
		return obj instanceof AnchorFieldExpression;
	}
